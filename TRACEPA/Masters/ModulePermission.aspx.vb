...
Partial Class ModulePermission
    ...
    Public Function GetReportDetails(ByVal RefDt As DataTable) As DataTable
        ...
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "GetReportDetails" & "Error_Line ='" & objclsGeneralFunctions.GetLineNumber(ex) & "'" & "") 'changes 06-08-2019
        End Try
    End Function
    ...
    Private Sub dgAccessRgt_ItemDataBound(sender As Object, e As DataGridItemEventArgs) Handles dgAccessRgt.ItemDataBound
        ...
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgAccesssRgt_ItemDataBound" & "Error_Line ='" & objclsGeneralFunctions.GetLineNumber(ex) & "'" & "") 'changes 06-08-2019
        End Try
    End Sub
