<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AccountPolicies.aspx.vb" Inherits="TRACePA.AccountPolicies" %>
        ...
        <div class="card">
            <div runat="server" id="divAssignmentheader" class="card-header">
                <i class="fa fa-pencil-square" style="font-size: large"></i>&nbsp;                 
                    <asp:Label runat="server" ID="lblpendingtaskcount" CssClass="form-label" Font-Bold="true" Text="Accounting Policies" Font-Size="Small"></asp:Label>
                <div class="pull-right" style="padding-right: 15px;">
                    <asp:ImageButton ID="imgbtnAdd" Visible="false" CssClass="activeIcons hvr-bounce-out" ImageUrl="~/Images/Add24.png" runat="server" data-toggle="tooltip" data-placement="bottom" title="Add New" CausesValidation="false" />
...
<%--                <asp:RequiredFieldValidator ID="RFVHeading" runat="server" ControlToValidate="txtEnterHeading" CssClass="ErrorMsgRight" Display="Dynamic" SetFocusOnError="True" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                ...
                <div class="col-sm-1 col-md-1">
                    <div class="form-group">
                        <br />
                        <asp:Button ID="BtnAddDetails" CssClass="btn-ok"  runat="server" data-toggle="tooltip" data-placement="bottom" title="Save Changes" Text="Save Changes" />
                    </div>
                </div>
            </div>
