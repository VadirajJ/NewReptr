...
Imports System
Public Class DigitalVouchingDetails
    ...
    Private Sub BindCabinet()
        Try
            ...
            ddlcabinet.SelectedValue = objclsEdictGeneral.DecryptQueryString(HttpUtility.UrlDecode(Request.QueryString("CbnId")))
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub imgbtnBack_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnBack.Click
        ...
        Try
            Response.Redirect(String.Format("~/CustomerUsers/DigitalVouching.aspx?"), False) 'ADO/ADO_Dashboard
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
