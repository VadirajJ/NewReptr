    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                ddlIndex.SelectedValue = 1  'Added Steffi 28-06-2023 ' Default selecting cabinet
    ...
    Private Sub ddlIndex_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlIndex.SelectedIndexChanged
        ...
        Try
            ...
            If ddlIndex.SelectedIndex > 0 Then
                ...
                'Added Steffi 28-06-2023 ' Default selecting cabinet
...
dsearch:
                dtSearch = objclsSearch.SearchDocuments(sSession.AccessCode, sSession.AccessCodeID, sSession.UserID, sCab, sSubCab, sFol, sDocType, sKW, sDesc, sFDate, sTDate, sOCRTxt, sAnyDesc, sFrmt, sSession.UsrDeptID, "", sCrby, , sTitle)
    ...
    Private Sub imgbtnView_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnView.Click
        ...
        Try
            ...
            'Response.Redirect(String.Format("~/CustomerUsers/CustomerImageView.aspx"), False)
