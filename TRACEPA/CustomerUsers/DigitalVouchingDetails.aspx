<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CustomerUserMaster.Master" CodeBehind="DigitalVouchingDetails.aspx.vb" Inherits="TRACePA.DigitalVouchingDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">&nbsp;&nbsp;
    ...
    <div class="col-sm-3 col-md-3" style="padding-right: 0px">
        ...
        <asp:DropDownList ID="ddlcabinet" runat="server" AutoPostBack="true" CssClass="aspxcontrols" Enabled="false"></asp:DropDownList>
    </div>
    <div class="col-sm-3 col-md-3" style="padding-right: 0px">
        <asp:Label ID="Label1" runat="server" Text="* Sub Cabinet"></asp:Label>
                            ...
                            <div class="col-sm-12 col-md-12 form-group pull-left " style="padding: 0px">
                                ...
                                <div class="col-sm-12 col-md-12">
                                     <div class="col-sm-12 col-md-12 form-group">
                                        ...
                                        <asp:TextBox CssClass="aspxcontrols" runat="server" ID="txtComment" ValidateRequestMode="Disabled" 
                                            autoComplete="off" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="clearfix divmargin"></div>
                                <div class="col-sm-12 col-md-12" style="margin-right: 50%">
