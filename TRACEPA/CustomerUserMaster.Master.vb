...
Imports System.Data
Imports System.IO
Public Class CustomerUserMaster
    Inherits System.Web.UI.MasterPage
    Private Shared sFormName As String = "CustomerUser Masterpage"
    ...
    Private Sub GetSubMenuOpen()
        Try
            ...
            If sSession.SubMenu = "CustomerUSerHomepage" Then
        ...
        End Try
    End Sub
    Private Sub lnkbtnDU_Click(sender As Object, e As EventArgs) Handles lnkbtnDU.Click
        Try
            Response.Redirect("~/StandardAudit/DRLSamplingCU.aspx", False)
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkbtnDU_Click")
        End Try
    End Sub
    ...
    Protected Sub LnkDS_Click(sender As Object, e As EventArgs)
        Try
            sSession.SubMenu = "SearchDocuments" : sSession.Form = "SearchDocuments"
            Session("AllSession") = sSession
            Response.Redirect("~/CustomerUsers/SearchDocuments.aspx", False)
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "LnkDS_Click")
        End Try
    End Sub
    Protected Sub lnkDigitalVouching_Click(sender As Object, e As EventArgs)
        Try
            sSession.SubMenu = "DigitalVouching" : sSession.Form = "DigitalVouching"
            Session("AllSession") = sSession
            Response.Redirect("~/CustomerUsers/DigitalVouching.aspx", False)
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkDigitalVouching_Click")
        End Try
    End Sub
    Protected Sub LnkSAAuditorIssue_Click(sender As Object, e As EventArgs)
        Try
            Response.Redirect("~/StandardAudit/AuditorIssue.aspx", False)
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "LnkSAAuditorIssue_Click")
        End Try
    End Sub
    Protected Sub LnkSAMRAuditorIssue_Click(sender As Object, e As EventArgs)
        Try
            Response.Redirect("~/StandardAudit/MRIssue.aspx", False)
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "LnkSAMRAuditorIssue_Click")
        End Try
    End Sub
End Class