<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeBehind="AssignmentMaster.aspx.vb" Inherits="TRACePA.AssignmentMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=ddlAuditAssignment.ClientID%>').select2();
        ...
        <div class="card">
            <div runat="server" id="divAssignmentheader" class="card-header">
                <i class="fa fa-pencil-square" style="font-size: large"></i>&nbsp;
                    ...
                    <asp:Label runat="server" ID="lblpendingtaskcount" CssClass="form-label" Font-Bold="true" Text="Assignment Master" Font-Size="Small"></asp:Label>
        ...
        <div class="card">
            <div class="col-sm-12 col-md-12 divmargin">
                <div class="col-sm-4 col-md-4" style="padding: 0px">
                    <asp:Label ID="lblAuditAssignments" runat="server" Text="Audit Task/Assignments"></asp:Label>
                    <asp:DropDownList ID="ddlAuditAssignment" runat="server" AutoPostBack="true" CssClass="aspxcontrols">
                    </asp:DropDownList>
                </div>
            ...
            <div class="col-sm-12 col-md-12" runat="server" style="border-style: none; border-color: inherit; border-width: medium">
                <asp:GridView ID="gvGeneralMaster" CssClass="table bs" runat="server" HeaderStyle-CssClass="FixedHeader" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="cmm_desc" HeaderText="Task" ItemStyle-Width="23%" />
                        <asp:BoundField DataField="DescName" HeaderText="Sub Task" ItemStyle-Width="23%" />
                        <asp:BoundField DataField="Description" HeaderText="Description" ItemStyle-Width="30%" />
                        <asp:BoundField DataField="BillingType" HeaderText="Billing Type" ItemStyle-Width="15%" />
