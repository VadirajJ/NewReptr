...
Public Class clsStandardAudit
    ...
    Public Function LoadDashboardStandardAudit(ByVal sAc As String, ByVal iAcID As Integer, ByVal iFinancialYearID As Integer, ByVal iCustomerID As Integer, ByVal iLoginUserID As Integer, ByVal bLoginUserIsPartner As Boolean) As DataTable
        ...
        Try
            ...
            End If
            If bLoginUserIsPartner = False Then
                sSql = sSql & " And b.SA_AdditionalSupportEmployeeID Like ('%," & iLoginUserID & ",%')"
            End If
        ...
        End Try
    End Function
    Public Function LoadSelectedStandardAuditCheckPointDetails(ByVal sAc As String, ByVal iAcID As Integer, ByVal iAuditID As Integer) As DataTable
        Dim sSql As String
        Dim dt As New DataTable
        Try
    ...
    Public Function LoadSelectedStandardAuditCheckPointRemarksHistoryDetails(ByVal sAc As String, ByVal iAcID As Integer, ByVal iAuditID As Integer, ByVal iCheckPointID As Integer, ByVal iRemarksType As Integer) As DataTable
        ...
        Dim dt As New DataTable
        Try
            sSql = "Select Case When SCR_RemarksType=1 then 'Partner' When SCR_RemarksType=2 then 'Employee' When SCR_RemarksType=3 then 'Review Partner' End RemarksType,SCR_Remarks As Remarks,"
            sSql = sSql & " USr_FullName As RemarksBy,SCR_Date as Date From StandardAudit_ConductAudit_RemarksHistory Left Join sad_userdetails on Usr_ID=SCR_RemarksBy "
            sSql = sSql & " Where SCR_SA_ID=" & iAuditID & " And SCR_CheckPointID=" & iCheckPointID & " And SCR_CompID=" & iAcID & ""
            If iRemarksType = 1 Then
                sSql = sSql & " And SCR_RemarksType in (1,2)"
            End If
            If iRemarksType = 2 Then
                sSql = sSql & " And SCR_RemarksType=3"
            End If
            sSql = sSql & " Order by SCR_ID Desc"
            dt = objDBL.SQLExecuteDataTable(sAc, sSql)
            Return dt
        Catch ex As Exception
            Throw
    ...
    Public Sub UpdateScheduleCheckPointRemarksAnnexure(ByVal sAc As String, ByVal iAcID As Integer, ByVal iAuditID As Integer, ByVal iConductAuditCheckPointId As Integer, ByVal iCheckPointID As Integer, ByVal iRemarksType As Integer, ByVal sRemarks As String, ByVal iAnnexure As Integer,
        ...
        End Try
    End Sub
    Public Function LoadScheduledAuditAllCheckPoints(ByVal sAc As String, ByVal iAcID As Integer, ByVal iAuditID As Integer) As DataTable
        Dim sSql As String
        Try
            sSql = "Select ACM_ID,ACM_Checkpoint From AuditType_Checklist_Master Where ACM_ID in (Select SAC_CheckPointID From StandardAudit_ScheduleCheckPointList Where SAC_SA_ID=" & iAuditID & " And SAC_CompID=" & iAcID & ") And ACM_CompID=" & iAcID & " Order by ACM_ID"
            Return objDBL.SQLExecuteDataTable(sAc, sSql)
        Catch ex As Exception
            Throw
        End Try
    End Function
    Public Function GetSamplingAuditAttachmentID(ByVal sAC As String, ByVal iACID As Integer, ByVal iAuditID As Integer, ByVal iCheckPointID As Integer) As String
        Dim sSql As String
        Try
        ...
        End Try
    End Function
    Public Sub SaveSamplingAttachmentInAudit(ByVal sAC As String, ByVal iACID As Integer, ByVal iAttachID As Integer, ByVal iAuditID As Integer, ByVal iCheckPointID As Integer)
        Dim sSql As String
        Try
    ...
    Public Function LoadSAObservationsQuerySummary(ByVal sAc As String, ByVal iAcID As Integer, ByVal iAuditID As Integer, ByVal iCustomerId As Integer, ByVal iYearID As Integer) As DataTable
        ...
        Try
            ...
            sSql = "SELECT " & dtCount.Rows.Count & " AS TotalLedger,COUNT(DISTINCT CASE WHEN SRO_AuditId=" & iAuditID & " AND SRO_CompID=" & iAcID & " THEN SRO_AEU_ID END) AS TotalObservations,"
            sSql = sSql & " COUNT(DISTINCT CASE WHEN SRO_IsIssueRaised=1 AND SRO_AuditId=" & iAuditID & " AND SRO_CompID=" & iAcID & " THEN SRO_AEU_ID END) AS TotalIssueRaised,COUNT(DISTINCT CASE WHEN SRO_IsIssueRaised > 1 AND SRO_AuditId=" & iAuditID & " AND SRO_CompID=" & iAcID & " THEN SRO_AEU_ID END) AS ClientResponse"
