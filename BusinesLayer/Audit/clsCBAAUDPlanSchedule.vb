...
Public Class clsCBAAUDPlanSchedule
    ...
    Public Function CheckForScheduledData(ByVal sAC As String, ByVal iAcID As Integer, ByVal iAuditId As Integer, ByVal iCustID As Integer, ByVal iMonthid As Integer, ByVal iYearID As Integer) As Integer
        ...
        Try
            sSql = "select AUD_ID from CBAaudit_schedule where AUD_SectionID=" & iAuditId & " and AUD_KitchenID=" & iCustID & " and AUD_MonthID=" & iMonthid & "  and AUD_YearID=" & iYearID & " and AUD_CompID=" & iAcID & ""
    ...
    Public Function GetAuditCode(ByVal sAC As String, ByVal iAudID As Integer, ByVal sYearName As String, ByVal iMonthID As Integer, ByVal iYearId As Integer) As String
        ...
        Try
            iMaxID = objDBL.SQLExecuteScalarInt(sAC, "Select Count(*)+1 from CBAAudit_schedule where AUD_yearID=" & iYearId & "")
    ...
    Public Function LoadAuditSchedule(ByVal sAC As String, ByVal iACID As Integer, ByVal iYearID As Integer, ByVal iMonthID As Integer, ByVal iSecID As Integer) As DataTable
        ...
        Try
            ...
            sSql = sSql & " c.usr_FullName as name from CBAaudit_schedule a "
            sSql = sSql & " Left Join sad_customer_master b on a.AUD_KitchenID=b.cust_id and b.cust_compid=" & iACID & ""
            sSql = sSql & " Left Join sad_userdetails c on c.usr_id=a.AUD_AuditorIDs and c.usr_compid=" & iACID & " "
            ...
            If dt.Rows.Count <> 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    End If
                    If IsDBNull(dt.Rows(i).Item("name")) = False Then
                        drow("Auditor") = dt.Rows(i).Item("name")
                    End If
    ...
    Public Function LoadSelectedScheduleDetails(ByVal sAC As String, ByVal iACID As Integer, ByVal iYearID As Integer, ByVal iMonthId As Integer, ByVal iSecID As Integer, ByVal ICustID As Integer) As DataTable
        ...
        Dim dt As New DataTable
        Try
            sSql = "Select * From CBAaudit_schedule Where AUD_Monthid=" & iMonthId & " And AUD_SectionID=" & iSecID & " and AUD_Yearid=" & iYearID & " and AUD_CompID= " & iACID & ""
            If ICustID > 0 Then
        ...
        End Try
    End Function
    Public Function SaveScheduleDetails(ByVal sAC As String, ByVal objSchedule As clsCBAAUDPlanSchedule) As Array
        ...
        Try
            ...
            ObjParam(iParamCount) = New OleDb.OleDbParameter("@AUD_AuditorID", OleDb.OleDbType.VarChar, 500)
            ...
            Arr = objDBL.ExecuteSPForInsertARR(sAC, "spCBAAudit_Schedule", 1, Arr, ObjParam)
            Return Arr
        Catch ex As Exception
            Throw
        End Try
