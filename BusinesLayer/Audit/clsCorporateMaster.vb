Public Class clsCorporateMaster
    ...
    Public Function LoadAllSections(ByVal sAc As String, ByVal iACID As Integer, ByVal iStatus As Integer) As DataTable
        ...
        Try
            ...
            sSql = "Select CAS_ID,CAS_CODE,CAS_SECTIONNAME,CAS_DELFLG,CAS_POINTS,CAS_Desc,CAS_POINTS From CRPA_section where  CAS_CompId =" & iACID & ""
    ...
    Public Function SaveSectionDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objSection As clsCorporateMaster) As Array
        ...
        End Try
    End Function
    Public Function SavesSectionDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objsubSection As clsCorporateMaster) As Array
        ...
        End Try
    End Function
    Public Function SaveProcessDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objProcess As clsCorporateMaster) As Array
        ...
        End Try
    End Function
    Public Function SaveSubProcessSectionDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objsProcess As clsCorporateMaster) As Array
