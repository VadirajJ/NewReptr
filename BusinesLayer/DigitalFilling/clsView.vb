...
LP:             dtMain = BuildPermDataSet(sAC, iUserId, iFolId, sMem, iChkType)
    ...
    Public Function GetPageFromEdict(ByVal sAC As String, ByVal iSelectedIndexID As Integer, ByVal iuserID As Integer) As String
        ...
        Try
            ...
            oPath = objclsEDICTGeneral.GetDecPathView(sTemp, iuserID, sImagePath, iSelectedIndexID, sExt)
    ...
    Public Function LoadListFiles(ByVal sAC As String, ByVal iBaseID As Integer) As DataTable
        ...
        Dim dt As New DataTable
        Try
            sSql = "Select pge_basename from EDT_PAGE where pge_status <> 'X' and Pge_Details_Id=" & iBaseID & " ORDER BY PGE_PAGENO"  'Vijeth
            'Select * from EDT_PAGE where pge_status <> 'X' and Pge_Details_Id=12 or PGE_BASENAME=12 ORDER BY PGE_PAGENO  Change for change
            dt = objDBL.SQLExecuteDataTable(sAC, sSql)
            Return dt
        Catch ex As Exception
            Throw
    ...
    Public Function DisplayVersion(ByVal iBaseName As String) As DataTable
        ...
        Dim dRow As DataRow
        Try
            Dt.Columns.Add("VRS_Id")
            Dt.Columns.Add("VRS_VersionName")

            sSql = "Select VRS_Id,VRS_VersionName from EDT_VersionInfo where VRS_Basename = " & iBaseName & " And VRS_Parent = -1 order by VRS_Id"
    ...
    Public Function GetNewVersion(ByVal sBasename As String) As String
        ...
        End Try
    End Function
    Public Function SaveVersion(ByVal iBaseName As Integer, ByVal irevno As Integer, ByVal sRevdate As DateTime, ByVal sRemarks As String, ByVal sFileName As String, ByVal iParent As Integer, ByVal lblId As Integer, ByVal iUsrId As Integer, ByVal iNewRevNo As Integer) As Integer
    ...
    End Function
    'Rakshan Added
    Public Function LoadCabinetID(ByVal sNameSpace As String, ByVal iCOmpID As Integer, ByVal CabName As String) As Integer
        Dim sSql As String = ""
        Try
            sSql = "" : sSql = "Select CBN_ID from edt_cabinet a,Sad_Org_Structure b where a.CBN_Department=b.Org_node and CBN_Parent=-1 and a.CBN_DelFlag='A' and CBN_NAME='" & CabName & "'"
            sSql = sSql & " Order by CBN_NAME"
        ...
        End Try
    End Function
    Public Function LoadSubCabId(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iParent As Integer, ByVal SubCabName As String) As Integer
        Dim sSql As String = ""
        Try
            sSql = "" : sSql = "Select CBN_ID from edt_cabinet "
            sSql = sSql & " where CBN_PARENT =" & iParent & " and CBN_DelFlag ='A' and CBN_CompID =" & iCompID & " and CBN_NAME='" & SubCabName & "' order by cbn_name"
            Return objDBL.SQLExecuteScalarInt(sNameSpace, sSql)
        Catch ex As Exception
            Throw
        End Try
    End Function
    Public Sub PermanetDeleteVersion(ByVal sAC As String, ByVal iACID As Integer, ByVal iVersionID As Integer)
        Dim sSql As String = ""
        Try
            sSql = "delete from EDT_VERSIONINFO Where VRS_Id=" & iVersionID & ""
